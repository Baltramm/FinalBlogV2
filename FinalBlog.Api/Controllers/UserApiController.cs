...
namespace FinalBlog.Api.Controllers
{
    /// <summary>
    ...
    public class UserApiController : ControllerBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// Данный метод позволяет создать нового пользователя. Подробное описание свойств  -  см. схему UserApiCreateModel
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Данный метод позволяет обновлять информацию существующего пользователя. Подробное описание свойств  -  см. схему UserApiUpdateModel
        /// </remarks>
